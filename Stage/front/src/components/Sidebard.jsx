...
const Sidebard = () => {
 ...
 function handleOpen(){
  ...
  const navmenu = [
    { nom: "Tableau de Bord", link: "/", icon: MdOutlineDashboard },
    { nom: "Ventes", link: "/admin/vente", icon: MdOutlineAddShoppingCart,margin:true},
    { nom: "Produits", link: "/", icon: MdOutlineSpoke },
    { nom: "Garde", link: "/", icon: MdOutlineDashboard },
    { nom: "Programe ", link: "/", icon: MdOutlineListAlt },
    { nom: "Employer ", link: "/", icon:MdOutlineAdminPanelSettings, margin:true },
    { nom: "Utilisateur ", link: "/", icon:MdOutlineGroup },
    { nom: "Se deconnecter", link: "/", icon:MdOutlineLogout },
  ];

  return (
    <div className={`dark:bg-slate-800 bg-green-100 min-h-screen  relative ${open ? 'w-72' :'w-16'} text-green-950 dark:text-green-100 px-4 backdrop-blur-sm `}>
